...
$presente=mysqli_num_rows($result_qanamnesi);
$anamnesipd=mysqli_fetch_assoc($result_qanamnesi);
...
if (!$r_qlog_ins = $mysqli->query($qlog_ins)) echo "Query error";
if ($log_ins=mysqli_fetch_assoc($r_qlog_ins)) {
...
if (!$r_qlog_upd = $mysqli->query($qlog_upd)) echo "Query error";
if ($log_upd=mysqli_fetch_assoc($r_qlog_upd)) {
...
<div class="form_riga"><span class="form_sn">Familiarit&agrave;: </span><input class="form_dx" type="text" name="familia" value="<?=$familia?>" /></div>

<div class="form_riga"><span class="form_sn">Et&agrave; di esordio: </span><input class="form_dx" type="number" name="esordio_eta" value="<?=$esordio_eta?>" /></div>
...
<div class="form_riga"><span class="form_sn">&nbsp;&nbsp;-Allucinazioni: </span><input class="form_dx" type="text" name="compli_allu" value="<?=$compli_allu?>" /></div>
<div class="form_riga"><span class="form_sn">&nbsp;&nbsp;-Disturbi del sonno: </span><input class="form_dx" type="text" name="compli_sonno" value="<?=$compli_sonno?>" /></div>
<div class="form_riga"><span class="form_sn">&nbsp;&nbsp;-Deficit cognitivi: </span><input class="form_dx" type="text" name="compli_cogni" value="<?=$compli_cogni?>" /></div>
<div class="form_riga"><span class="form_sn">&nbsp;&nbsp;-Disautonomia: </span><input class="form_dx" type="text" name="compli_vegeta" value="<?=$compli_vegeta?>" /></div>
...
<div class="form_riga"><span class="form_sn">Numero di cadute nell'ultimo anno (se non cade mettere 0): </span><input class="form_dx" type="number" name="cadute" size="3,1" value="<?=$cadute?>" /></div>
