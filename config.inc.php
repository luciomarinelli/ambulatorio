...
//lista anamnesi
$listanamnesi = array ("anamnesipd" => "Anamnesi Parkinson");

//lista scale cliniche
$listascale = array ("hy" => "Hoehn & Yahr", "updrs" => "Unified Parkinson Disease Rating Scale", "mmse" => "Mini Mental Status Examination");
