...
if ($from_emailaddress>"") xmail($to_emailaddress,$from_emailaddress, "phpMySQLAutoBackup: $conf_titolo", $dump_buffer, $backup_file_name, $backup_type, $newline, $phpMySQLAutoBackup_version);
