Ambulatorio - release 20161219 - December 19, 2016
...
This software have been written by Lucio Marinelli http://www.luciomarinelli.com with the exception of the code to generate the "CODICE FISCALE" that has been written by Riccardo Frizzoni (GPL2) and the code to perform the automated backup of the database that has been written by David G Walker BSc (http://www.dwalker.co.uk) (GPL2).
